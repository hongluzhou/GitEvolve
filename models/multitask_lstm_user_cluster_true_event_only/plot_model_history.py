...
if __name__ == '__main__':
    ...
    # ============= load history files
    model_path = '/media/data1/github_paper_exp/exp/aug7_2_vanilla/models/'
    history_file = 'history-{}.pickle'.format('30')
    ...
    if 'user_cluster_output_categorical_accuracy' in history:
        print_and_log(
                logger,
                "Highest user cluster validation accuracy "
                "was at epoch {}".format(
                        np.argmax(history[
                                'val_user_cluster_output_categorical_accuracy']
                              )+1))
    else:
        print_and_log(
                logger,
                ...
                "was at epoch {}".format(
                        np.argmax(history[
                                'val_user_cluster_output_mean_squared_error']
                              )+1))
