...
if __name__ == '__main__':
    ...
    plt.plot(history['mean_squared_error'], '-',
             marker='.',
             label='training mean squared error')
    ...
    print_and_log(logger,
                  "Highest mean_squared_error was at "
                  "epoch {}".format(np.argmax(
                          history['mean_squared_error']
                          )+1))
    print_and_log(logger,
                  "Lowest mean_squared_error was at "
                  "epoch {}".format(np.argmin(
                          history['mean_squared_error']
                          )+1))
    ...
    print_and_log(logger,
                  "Highest val_mean_squared_error was at "
                  "epoch {}".format(np.argmax(
                          history['val_mean_squared_error']
                          )+1))

    print_and_log(logger,
                  "Lowest val_mean_squared_error was at "
                  "epoch {}".format(np.argmin(
                          history['val_mean_squared_error']
                          )+1))
