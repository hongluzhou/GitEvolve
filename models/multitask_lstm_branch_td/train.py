...
def train_models(config):
    ...
    #                        time_delay_output,
    #                        user_cluster_output])
    model = Model(inputs=input_sequences, outputs=time_delay_output)
    ...
    # train val generator
    training_generator = DataGenerator_TD(
    ...
    validation_generator = DataGenerator_TD(
            os.path.join(config['exp_save_dir'], "dataset"),
...
class DataGenerator_TD(keras.utils.Sequence):
    """
    Reference:
