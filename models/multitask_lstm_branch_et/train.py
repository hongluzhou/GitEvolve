...
def train_models(config):
    ...
    #                        time_delay_output,
    #                        user_cluster_output])
    model = Model(inputs=input_sequences, outputs=event_type_output)
    ...
    # train val generator
    training_generator = DataGenerator_ET(
    ...
    validation_generator = DataGenerator_ET(
            os.path.join(config['exp_save_dir'], "dataset"),
...
class DataGenerator_ET(keras.utils.Sequence):
    """
    Reference:
