...
def create_path_config():
    ...
    path_config = {
            ...
            'exp_save_dir': os.path.join(
                    root_dir, 'exp', 'www_get_statistics'),  # www_branch_uc
...
def create_evaluation_config():
    config = {
            ...
            'time_delay_overall_evaluation': False,

            'user_cluster_nlg_eval': True,
            'user_cluster_map_eval': True,
            'user_cluster_categorical_accuracy_eval_given_gt': True,
            'user_cluster_percentage_eval': True,
